...
- 데이터는 db.py를 통해 SQLite(data/smartfarm.db)에 저장됨
"""
...
import db
from common import init_common_session_state, render_sidebar_settings, WORK_TYPES

# ------------------------------------------------------------
# 페이지 설정 + 공통 초기화
# ------------------------------------------------------------
st.set_page_config(page_title="영농일지 - 스마트팜 관리", page_icon="📝", layout="wide")
