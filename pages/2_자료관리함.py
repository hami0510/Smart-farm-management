...
import db
from common import init_common_session_state, render_sidebar_settings, DOC_CATEGORIES

# ------------------------------------------------------------
# 페이지 설정 + 공통 초기화
# ------------------------------------------------------------
st.set_page_config(page_title="자료 관리함 - 스마트팜 관리", page_icon="📁", layout="wide")

db.init_db()
init_common_session_state()

BASE_DIR = Path(__file__).parent.parent  # pages/ 폴더의 상위 = 프로젝트 루트
